 ...
 *  - minimal: when true, renders only the track without the percentage /
 *    time / speed / ETA detail row.
 */
 ...
 *   soft resting shadow.
 * @param {boolean} [props.minimal] - When true, the percentage/time/speed/ETA
 *   detail row is omitted.
 * @returns {JSX.Element} The progress track (and info row unless minimal).
 */

# 🛡️ Error Monitoring (Sentry, swappable)
...
- Usage analytics live on a **separate layer** since 1.0.0-beta.4 — see
  [[Analytics]]. Product events no longer travel through Sentry breadcrumbs.

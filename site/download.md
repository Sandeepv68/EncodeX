...
**Just want it to work?** Click the first button â€” it's right for almost everyone.

| | Download | For |
|---|---------|-----|
| âœ… **Recommended** | [Download for Windows](https://github.com/Sandeepv68/EncodeX/releases/latest/download/EncodeX-1.0.0-beta.0-x64-setup.exe) | Most PCs and laptops (64-bit) |
...
Not sure which one to pick? Go with the recommended one â€” if it doesn't match, Windows will tell you.
...
::: warning First launch on Mac â€” one extra step
...
You only need to do this once â€” after that it opens normally.
:::
...
| | Download | For |
|---|---------|-----|
| âœ… **Recommended** | [Download AppImage](https://github.com/Sandeepv68/EncodeX/releases/latest/download/EncodeX-1.0.0-beta.0-x86_64.AppImage) | Most Linux computers (64-bit) |
...
**To run:** an AppImage is a single file â€” no installation needed. Just make it runnable and double-click it:
...
(Many desktop environments also let you skip the terminal: right-click the file â†’ Properties â†’ allow executing, then double-click.)

## What Your Computer Needs

Nothing special â€” if your computer is from the last several years, you're fine:

- **Operating system:** Windows 10+, macOS 11+, or a modern Linux
- **Disk space:** about 400 MB (the app includes everything it needs â€” no extra downloads)
- **Memory:** any normal amount works

## Keeping It Up to Date

When a new version comes out, EncodeX lets you know inside the app and can download and start the update for you â€” no need to revisit this page.

## Need Help?

If something isn't working or you have a question, send an email to **[developer@encodex.in](mailto:developer@encodex.in)** â€” you'll hear back from a real person.

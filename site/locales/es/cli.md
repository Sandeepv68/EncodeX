...
## Los mismos cuatro pasos

Conversión por CLI o por interfaz: el flujo es idéntico — eliges una meta, EncodeX hace la codificación:
...
Desde la terminal, ese mismo perfil «Teléfono» está a una bandera de distancia:

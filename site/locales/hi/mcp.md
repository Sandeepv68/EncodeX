---
title: "वीडियो कन्वर्ज़न के लिए MCP सर्वर – AI को EncodeX चलाने दें | EncodeX"
description: "EncodeX में एक बिल्ट-इन MCP सर्वर (Model Context Protocol) शामिल है। Claude, Claude Code, Cursor या VS Code को कनेक्ट करें और सादी भाषा में कन्वर्ट करने, ऑडियो निकालने, कंप्रेस करने या बैच जॉब ट्रैक करने को कहें — सब आपके अपने कंप्यूटर पर।"

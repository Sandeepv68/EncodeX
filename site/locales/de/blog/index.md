...
Willkommen im EncodeX-Blog. Hier finden Sie Release-Ankündigungen, Änderungsprotokolle und Neuigkeiten zum Projekt.
...
<div v-else>
  <p>Noch keine Beiträge. Schauen Sie bald wieder vorbei!</p>
</div>

## EncodeX entdecken

- [EncodeX herunterladen](/de/download) — kostenlos für Windows, Mac und Linux
- [Alle Funktionen ansehen](/de/features) — Screenshots und Anleitungen
- [Technische Dokumentation](/de/docs/architecture) — wie EncodeX aufgebaut ist
- [Mitwirken](/de/contributing) — Fehler melden, Funktionen vorschlagen oder Code beitragen
